...
class DescriptionFragment : Fragment() {
    ...
    private var drugsFragment = DrugsFragment()
    ...
    override fun onCreateView(
        ...
        var btnDescriptionNext = v.findViewById<Button>(R.id.btn_description_next) as Button

        btnDescriptionNext.setOnClickListener {
            var fragmentTransaction = fragmentManager!!.beginTransaction()
            fragmentTransaction.replace(R.id.demande_fragment_container, drugsFragment)
